...
@SpringBootTest(classes = { dnd.dm.model.source.SMProficiencyFactory.class})
public class SMProficiencyFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMProficiencyFactory.getInstance();
