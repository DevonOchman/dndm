...
@SpringBootTest(classes = { dnd.dm.model.source.SMLanguageFactory.class})
public class SMLanguageFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMLanguageFactory.getInstance();
