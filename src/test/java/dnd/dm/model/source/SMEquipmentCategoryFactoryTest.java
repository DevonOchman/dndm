...
@SpringBootTest(classes = { dnd.dm.model.source.SMEquipmentCategoryFactory.class})
public class SMEquipmentCategoryFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMEquipmentCategoryFactory.getInstance();
