...
@SpringBootTest(classes = { dnd.dm.model.source.SMWeaponPropertyFactory.class})
public class SMWeaponPropertyFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMWeaponPropertyFactory.getInstance();
