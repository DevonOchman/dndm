...
@SpringBootTest(classes = { dnd.dm.model.source.SMDamageTypeFactory.class})
public class SMDamageTypeFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMDamageTypeFactory.getInstance();
