...
@SpringBootTest(classes = { dnd.dm.model.source.SMLevelFactoryTest.class })
public class SMSubraceFactoryTest {

	private File sourceFile = null;

	private SMFactory subject = SMSubraceFactory.getInstance();

	@Before
	public void init() {
		sourceFile = new File(
				getClass().getClassLoader().getResource("ModelSource/" + subject.getSourceFileName()).getFile());
