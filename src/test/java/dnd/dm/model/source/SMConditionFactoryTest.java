...
@SpringBootTest(classes = { dnd.dm.model.source.SMConditionFactory.class})
public class SMConditionFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMConditionFactory.getInstance();
