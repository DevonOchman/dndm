...
@SpringBootTest(classes = { dnd.dm.model.source.SMMonsterFactory.class})
public class SMMonsterFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMMonsterFactory.getInstance();
