...
@SpringBootTest(classes = { dnd.dm.model.source.SMMagicSchoolFactoryTest.class})
public class SMMagicSchoolFactoryTest {
private File sourceFile = null;
	
	private SMFactory subject = SMMagicSchoolFactory.getInstance();
