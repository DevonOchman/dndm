...
@SpringBootTest(classes = { dnd.dm.model.source.SMAbilityScoreFactory.class})
public class SMAbilityScoreFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMAbilityScoreFactory.getInstance();
