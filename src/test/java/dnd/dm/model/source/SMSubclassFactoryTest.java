...
@SpringBootTest(classes = { dnd.dm.model.source.SMSubclassFactory.class})
public class SMSubclassFactoryTest {
	
	private File sourceFile = null;
	
	private SMFactory subject = SMSubclassFactory.getInstance();
